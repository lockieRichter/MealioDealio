...
abstract class $IngredientCopyWith<$Res> {
  ...
  @useResult
  $Res call({IngredientCategory category, String name});
}
...
class _$_Ingredient implements _Ingredient {
  const _$_Ingredient({required this.category, required this.name});
  ...
  @override
  String toString() {
    return 'Ingredient(category: $category, name: $name)';
  }
